...
const BOARD_END_SCREEN_GAMES = new Set(['catan', 'battleship', 'poker', 'uno', 'monopoly', 'codenames', 'pictionary', 'scribbleio'])
...
export default function GamePlayPage() {
  ...
  const mockGames = {
    monopoly: {
      ...
      image: '/images/games/property-empire.jpg',
      minPlayers: 2,
      maxPlayers: 6,
      duration: '60-180 min',
      complexity: 'Medium'
    ...
    uno: {
      ...
      image: '/images/games/color-clash.jpg',
      minPlayers: 2,
      maxPlayers: 10,
      duration: '15-30 min',
      complexity: 'Easy'
    ...
    poker: {
      ...
      image: '/images/poker thumbnail.jpg',
      minPlayers: 2,
    ...
    cluedo: {
      ...
      image: '/images/games/mystery-manor.jpg',
      minPlayers: 3,
      maxPlayers: 6,
      duration: '45-60 min',
      complexity: 'Easy'
    ...
    pictionary: {
      ...
      image: '/images/games/quick-draw.jpg',
      minPlayers: 4,
      maxPlayers: 8,
      duration: '30-60 min',
      complexity: 'Easy'
    ...
    scribbleio: {
      ...
      image: '/images/games/doodle-dash.jpg',
      minPlayers: 2,
      maxPlayers: 16,
      duration: '15-30 min',
      complexity: 'Easy'
    ...
    codenames: {
      ...
      image: '/images/games/spymaster.jpg',
      minPlayers: 4,
      maxPlayers: 8,
      duration: '15-30 min',
      complexity: 'Easy'
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#2b2118] via-[#32271b] to-[#3c2f20] p-0 m-0 overflow-hidden">
